...
/**
 * Used to demo the self shadow.
 */
public class GLES2_Self_Shadow_Object_Activity extends AppCompatActivity {
    ...
    private class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 unused, EGLConfig config) {
            ...
            Context context = GLES2_Self_Shadow_Object_Activity.this;
        ...
        public void onDrawFrame(GL10 unused) {
            ...
            mTeapot.draw(lightVPMatrix, mTeapotModule, mEyePoint, shadowEffectData);
            ...
            mTeapot.draw(vpMatrix, mTeapotModule, mEyePoint, new ShadowEffectData(mShadow, mLight, lightVPMatrix));
