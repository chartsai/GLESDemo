...
import idv.chatea.gldemo.lighting.ComplexLight;
import idv.chatea.gldemo.lighting.ComplexLightObjObject;
import idv.chatea.gldemo.objloader.BasicObjLoader;
import idv.chatea.gldemo.objloader.SmoothObjLoader;

public class GLES2_Complex_Light_Obj_Activity extends AppCompatActivity {
    ...
    private class MyRenderer implements GLSurfaceView.Renderer {
        ...
        private ComplexLightObjObject mLightObjObject;

        private ComplexLight mLight;
        ...
        public void onSurfaceCreated(GL10 unused, EGLConfig config) {
            ...
            Context context = GLES2_Complex_Light_Obj_Activity.this;

            BasicObjLoader loader = new SmoothObjLoader();

            mLightObjObject = new ComplexLightObjObject(context, loader.loadObjFile(context, "teapot/teapot.obj"));

            mLight = new ComplexLight();
            mLight.setPosition(200, 200, 200, 1.0f);
            mLight.setAmbientChannel(0.15f, 0.15f, 0.15f, 1.0f);
            mLight.setDiffusionChannel(0.3f, 0.3f, 0.3f, 1.0f);
            mLight.setSpecularChannel(0.4f, 0.4f, 0.4f, 1.0f);
        }
