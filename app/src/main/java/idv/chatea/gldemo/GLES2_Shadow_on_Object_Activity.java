...
import idv.chatea.gldemo.shadow.ShadowTextureObjObject;

/**
 * Demo for rendering shadow on texture light obj.
 */
public class GLES2_Shadow_on_Object_Activity extends AppCompatActivity {
    ...
    private class MyRenderer implements GLSurfaceView.Renderer {
        ...
        private float mViewDistance = 500;
        ...
        private ShadowTextureObjObject mTeapot;
        private float[] mTeapotModule1 = new float[16];
        private float[] mTeapotModule2 = new float[16];
        ...
        public void onSurfaceCreated(GL10 unused, EGLConfig config) {
            ...
            Context context = GLES2_Shadow_on_Object_Activity.this;
            ...
            bitmap = Utils.loadFromAssetsImage(context, "teapot/default.png");
            mTeapot = new ShadowTextureObjObject(context, loader.loadObjFile(context, "teapot/teapot.obj"), bitmap);
            bitmap.recycle();
            Matrix.setIdentityM(mTeapotModule1, 0);
            Matrix.translateM(mTeapotModule1, 0, 40, 0, -40);
            Matrix.rotateM(mTeapotModule1, 0, -60, 0, 1, 0);
            Matrix.setIdentityM(mTeapotModule2, 0);
            Matrix.translateM(mTeapotModule2, 0, -40, 0, 40);
            Matrix.rotateM(mTeapotModule2, 0, -30, 0, 1, 0);
        ...
        public void onDrawFrame(GL10 unused) {
            ...
            Matrix.multiplyMM(mTeapotModule1, 0, rotateMatrix, 0, mTeapotModule1, 0);
            Matrix.multiplyMM(mTeapotModule2, 0, rotateMatrix, 0, mTeapotModule2, 0);
            ...
            ShadowEffectData shadowEffectData = new ShadowEffectData(mShadow, mLight, lightVPMatrix);

            mShadow.startDrawShadowTexture();
            GLES20.glClear(GLES20.GL_DEPTH_BUFFER_BIT);
            mTeapot.draw(lightVPMatrix, mTeapotModule1, mEyePoint, shadowEffectData);
            mTeapot.draw(lightVPMatrix, mTeapotModule2, mEyePoint, shadowEffectData);
            ...
            mTeapot.draw(vpMatrix, mTeapotModule1, mEyePoint, new ShadowEffectData(mShadow, mLight, lightVPMatrix));
            mTeapot.draw(vpMatrix, mTeapotModule2, mEyePoint, new ShadowEffectData(mShadow, mLight, lightVPMatrix));
